<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col">
                <label for="sector">{{ __('Service') }} <span class="text-danger">*</span></label><br>
                <div class="form-check form-check-inline">
                  <input wire:model="new" value="1" class="form-check-input" type="radio" name="status" id="status1">
                  <label class="form-check-label" for="status1">
                      {{ __('New') }}
                  </label>
                </div>
                <div class="form-check form-check-inline">
                  <input wire:model="new" value="0" class="form-check-input" type="radio" name="status" id="status2" checked>
        ...
        <div class="row">
            <div class="col">
                ...
                <input wire:model="search_string" wire:keydown.backspace="$set('service_id', 0)"
                   class="form-control"
                   type="search" placeholder="{{ __('Search') }}" >
                <x-form.error key="search_string"/>
                @if(!$service_id)
                            ...
                            <a href="#" wire:click="selectService({{ $dt->ser_id }}, '{{ $dt->namekh }}')" >
                                <div class="d-flex">
                                    <div class="text-sm text-muted pt-2">
                                        <h6 class="mb-0">
                                            {{ $dt->namekh }} ({{ $dt->service_type }}) |
                                            {{ $dt->brand_namekh }}
                                        </h6>
                                        <p class="mb-0 "> អាជីវកម្ម៖{{ $dt->business_type }}  </p>
                                    </div>
                                </div>
                            </a>
                        </li>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <select wire:model.lazy="service_type_id" name="service_type_id" id="service_type_id" class="{{ $errors->has('service_type_id') ? 'form-control is-invalid' : 'form-control' }}">
                    <option value="">--{{ __('Choose') }}--</option>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <select wire:model.lazy="village_id" name="village_id" id="village_id"  class="{{ $errors->has('village_id') ? 'form-control is-invalid' : 'form-control' }}">
                    <option value="">--{{ __('Choose') }}--</option>
